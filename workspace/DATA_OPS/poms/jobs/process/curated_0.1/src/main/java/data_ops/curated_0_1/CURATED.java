...
// ###############################
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						"D:/DATA_OPS_PROJETO/HARMONIZED/STG_VENDAS.CSV"/** End field tFileInputDelimited_2:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.ShipToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);

										} catch (java.lang.Exception ex_tFileInputDelimited_2) {
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"ShipToAddressID", "row1",
															rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2],
															ex_tFileInputDelimited_2),
													ex_tFileInputDelimited_2));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.TotalDue = ParserUtils.parseTo_Float(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
								...
								if (SAIDA != null) {
									...
									if (SAIDA.TotalDue != null) { // G_OutMain_AggR_546
										...
										if (operation_result_tAggregateRow_1.TotalDue_sum == null) {
											operation_result_tAggregateRow_1.TotalDue_sum = new BigDecimal(0)
													.setScale(4);
										}
										operation_result_tAggregateRow_1.TotalDue_sum = operation_result_tAggregateRow_1.TotalDue_sum
												.add(new BigDecimal(String.valueOf(SAIDA.TotalDue)));
										...
										if (SAIDA_VENDEDORES != null) {
											...
											if (SAIDA_VENDEDORES.TotalDue != null) { // G_OutMain_AggR_546
												...
												if (operation_result_tAggregateRow_2.TotalDue_sum == null) {
													operation_result_tAggregateRow_2.TotalDue_sum = new BigDecimal(0)
															.setScale(4);
												}
												operation_result_tAggregateRow_2.TotalDue_sum = operation_result_tAggregateRow_2.TotalDue_sum
														.add(new BigDecimal(String.valueOf(SAIDA_VENDEDORES.TotalDue)));
...
// ###############################      
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File("D:/DATA_OPS_PROJETO/CURATED/REL_VENDAS_V1.CSV"))
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					if (row3.OrderDate != null) {
						sb_tFileOutputDelimited_1.append(row3.OrderDate);
					}
...
// ###############################      
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File("D:/DATA_OPS_PROJETO/CURATED/REL_VENDAS_V2.CSV"))
						.getAbsolutePath().replace("\\", "/");
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					if (row6.OrderDate != null) {
						sb_tFileOutputDelimited_2.append(row6.OrderDate);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row6.OnlineOrderFlag != null) {
						sb_tFileOutputDelimited_2.append(row6.OnlineOrderFlag);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row6.CountryRegion != null) {
						sb_tFileOutputDelimited_2.append(row6.CountryRegion);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row6.TotalDue != null) {
						sb_tFileOutputDelimited_2.append(row6.TotalDue);
					}
					sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
					if (row6.SalesPerson != null) {
						sb_tFileOutputDelimited_2.append(row6.SalesPerson);
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"D:/DATA_OPS_PROJETO/RAW/FF_ADDRESS.CSV"/** End field tFileInputDelimited_1:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row2.AddressID = ParserUtils.parseTo_Integer(
				...
				try {
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DATA_OPS_PROJETO/HARMONIZED/STG_VENDEDOR.CSV", "UTF-8", ";", "\n", false, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											...
											"CustomerID", "row4", temp, ex_tFileInputDelimited_3),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ModifiedDate", "row4", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
// Start of branch "row4"
	...
	public static class SAIDA_VENDAS_REGIAOStruct
			implements routines.system.IPersistableRow<SAIDA_VENDAS_REGIAOStruct> {
		final static byte[] commonByteArrayLock_DATA_OPS_CURATED = new byte[0];
		static byte[] commonByteArray_DATA_OPS_CURATED = new byte[0];
	...
	public static class SAIDA_VENDAS_PRODUTOSStruct
			implements routines.system.IPersistableRow<SAIDA_VENDAS_PRODUTOSStruct> {
		final static byte[] commonByteArrayLock_DATA_OPS_CURATED = new byte[0];
		static byte[] commonByteArray_DATA_OPS_CURATED = new byte[0];
...
// ###############################
				...
				Object filename_tFileInputDelimited_4 = /** Start field tFileInputDelimited_4:FILENAME */
						"D:/DATA_OPS_PROJETO/HARMONIZED/STG_VENDAS.CSV"/** End field tFileInputDelimited_4:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_4 < rowtFileInputDelimited_4.length) {
									...
									if (rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4].length() > 0) {
										try {
											...
											row7.SalesOrderID = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_4 < rowtFileInputDelimited_4.length) {
									...
									if (rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4].length() > 0) {
										try {
											...
											row7.OrderDate = ParserUtils.parseTo_Date(
													rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4],
													"dd-MM-yyyy");
								...
								if (columnIndexWithD_tFileInputDelimited_4 < rowtFileInputDelimited_4.length) {
									...
									if (rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4].length() > 0) {
										try {
											...
											row7.ShipToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4]);

										} catch (java.lang.Exception ex_tFileInputDelimited_4) {
											rowstate_tFileInputDelimited_4.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"ShipToAddressID", "row7",
															rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4],
															ex_tFileInputDelimited_4),
													ex_tFileInputDelimited_4));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_4 < rowtFileInputDelimited_4.length) {
									...
									if (rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4].length() > 0) {
										try {
											...
											row7.BillToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4]);

										} catch (java.lang.Exception ex_tFileInputDelimited_4) {
											rowstate_tFileInputDelimited_4.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"BillToAddressID", "row7",
															rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4],
															ex_tFileInputDelimited_4),
													ex_tFileInputDelimited_4));
										}
...
// Start of branch "SAIDA_VENDAS_PRODUTOS"
										if (SAIDA_VENDAS_PRODUTOS != null) {
											...
											if (tHash_Lookup_row10 != null
													&& tHash_Lookup_row10.getCount(row10HashKey) > 1) { // G 071

												// System.out.println("WARNING: UNIQUE MATCH is configured for the
												// lookup 'row10' and it contains more one result from keys :
												// row10.AddressID = '" + row10HashKey.AddressID + "'");
											} // G 071
											...
											if (SAIDA_VENDAS_REGIAO != null) {
												...
												if (SAIDA_VENDAS_REGIAO.UnitPrice != null) { // G_OutMain_AggR_546
													...
													if (operation_result_tAggregateRow_3.UnitPrice_sum == null) {
														operation_result_tAggregateRow_3.UnitPrice_sum = new BigDecimal(
																0).setScale(4);
													}
													operation_result_tAggregateRow_3.UnitPrice_sum = operation_result_tAggregateRow_3.UnitPrice_sum
															.add(new BigDecimal(
																	String.valueOf(SAIDA_VENDAS_REGIAO.UnitPrice)));
...
// ###############################      
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File(
						"D:/DATA_OPS_PROJETO/CURATED/REL_VENDAS_REGIAO_MENSAL.CSV")).getAbsolutePath().replace("\\",
								"/");
				...
				for (AggOperationStruct_tAggregateRow_3 aggregated_row_tAggregateRow_3 : values_tAggregateRow_3) { // G_AggR_600
					...
					if (row11.OrderDate != null) {
						sb_tFileOutputDelimited_3.append(FormatterUtils.format_Date(row11.OrderDate, "MM-yyyy"));
					}
					sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
					if (row11.UnitPrice != null) {
						sb_tFileOutputDelimited_3.append(row11.UnitPrice);
					}
					sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
					if (row11.OrderQty != null) {
						sb_tFileOutputDelimited_3.append(row11.OrderQty);
					}
					sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
					if (row11.Name != null) {
						sb_tFileOutputDelimited_3.append(row11.Name);
					}
					sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
					if (row11.CountryRegion != null) {
						sb_tFileOutputDelimited_3.append(row11.CountryRegion);
					}
				...
				try {
					...
					try {
						fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DATA_OPS_PROJETO/HARMONIZED/STG_PRODUTOS.CSV", "US-ASCII", ";", "\n", false, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductID", "row9", temp, ex_tFileInputDelimited_5),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"StandardCost", "row9", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ListPrice", "row9", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductCategoryID", "row9", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductModelID", "row9", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							row9.DiscontinuedDate = fid_tFileInputDelimited_5
							...
							row9.ThumbnailPhotoFileName = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);
				...
				try {
					...
					try {
						fid_tFileInputDelimited_6 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DATA_OPS_PROJETO/HARMONIZED/STG_VENDAS_DETALHE.CSV", "US-ASCII", ";", "\n", false,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderID", "row8", temp, ex_tFileInputDelimited_6),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderDetailID", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"OrderQty", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductID", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"UnitPrice", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"UnitPriceDiscount", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"LineTotal", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ModifiedDate", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
	...
	public void tFileInputDelimited_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_5 - inputs:(SAIDA_VENDAS_PRODUTOS,row10)
				// outputs:(SAIDA_VENDAS_REGIAO)
				...
				Object filename_tFileInputDelimited_7 = /** Start field tFileInputDelimited_7:FILENAME */
						"D:/DATA_OPS_PROJETO/RAW/FF_ADDRESS.CSV"/** End field tFileInputDelimited_7:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_7 < rowtFileInputDelimited_7.length) {
									...
									if (rowtFileInputDelimited_7[columnIndexWithD_tFileInputDelimited_7].length() > 0) {
										try {
											...
											row10.AddressID = ParserUtils.parseTo_Integer(
...
// Start of branch "row10"
	...
	public static class SAIDA_VENDEDOR_MENSALStruct
			implements routines.system.IPersistableRow<SAIDA_VENDEDOR_MENSALStruct> {
		final static byte[] commonByteArrayLock_DATA_OPS_CURATED = new byte[0];
		static byte[] commonByteArray_DATA_OPS_CURATED = new byte[0];
	...
	public static class copyOfSAIDA_VENDAS_REGIAOStruct
			implements routines.system.IPersistableRow<copyOfSAIDA_VENDAS_REGIAOStruct> {
		final static byte[] commonByteArrayLock_DATA_OPS_CURATED = new byte[0];
		static byte[] commonByteArray_DATA_OPS_CURATED = new byte[0];
	...
	public static class copyOfSAIDA_VENDAS_PRODUTOSStruct
			implements routines.system.IPersistableRow<copyOfSAIDA_VENDAS_PRODUTOSStruct> {
		final static byte[] commonByteArrayLock_DATA_OPS_CURATED = new byte[0];
		static byte[] commonByteArray_DATA_OPS_CURATED = new byte[0];
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_4 = (new java.io.File(
						"D:/DATA_OPS_PROJETO/CURATED/REL_VENDAS_REGIAO_SEMANAL.CSV")).getAbsolutePath().replace("\\",
								"/");
...
// ###############################
				...
				Object filename_tFileInputDelimited_8 = /** Start field tFileInputDelimited_8:FILENAME */
						"D:/DATA_OPS_PROJETO/HARMONIZED/STG_VENDAS.CSV"/** End field tFileInputDelimited_8:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length) {
									...
									if (rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8].length() > 0) {
										try {
											...
											row12.SalesOrderID = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length) {
									...
									if (rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8].length() > 0) {
										try {
											...
											row12.OrderDate = ParserUtils.parseTo_Date(
													rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8],
													"dd-MM-yyyy");
								...
								if (columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length) {
									...
									if (rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8].length() > 0) {
										try {
											...
											row12.ShipToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8]);

										} catch (java.lang.Exception ex_tFileInputDelimited_8) {
											rowstate_tFileInputDelimited_8.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"ShipToAddressID", "row12",
															rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8],
															ex_tFileInputDelimited_8),
													ex_tFileInputDelimited_8));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_8 < rowtFileInputDelimited_8.length) {
									...
									if (rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8].length() > 0) {
										try {
											...
											row12.BillToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8]);

										} catch (java.lang.Exception ex_tFileInputDelimited_8) {
											rowstate_tFileInputDelimited_8.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"BillToAddressID", "row12",
															rowtFileInputDelimited_8[columnIndexWithD_tFileInputDelimited_8],
															ex_tFileInputDelimited_8),
													ex_tFileInputDelimited_8));
										}
...
// Start of branch "copyOfSAIDA_VENDAS_PRODUTOS"
										if (copyOfSAIDA_VENDAS_PRODUTOS != null) {
											...
											if (tHash_Lookup_row15 != null
													&& tHash_Lookup_row15.getCount(row15HashKey) > 1) { // G 071

												// System.out.println("WARNING: UNIQUE MATCH is configured for the
												// lookup 'row15' and it contains more one result from keys :
												// row15.AddressID = '" + row15HashKey.AddressID + "'");
											} // G 071
...
// Start of branch "copyOfSAIDA_VENDAS_REGIAO"
											if (copyOfSAIDA_VENDAS_REGIAO != null) {
												...
												while ((tHash_Lookup_row16 != null && tHash_Lookup_row16.hasNext())
														|| forceLooprow16) { // G_TM_M_043
...
// Start of branch "SAIDA_VENDEDOR_MENSAL"
													if (SAIDA_VENDEDOR_MENSAL != null) {
														...
														if (execStat) {
															runStat.updateStatOnConnection(iterateId, 1, 1,
																	"SAIDA_VENDEDOR_MENSAL");
														}

														StringBuilder sb_tFileOutputDelimited_4 = new StringBuilder();
														if (SAIDA_VENDEDOR_MENSAL.OrderDate != null) {
															sb_tFileOutputDelimited_4.append(FormatterUtils.format_Date(
																	SAIDA_VENDEDOR_MENSAL.OrderDate, "dd-MM-yyyy"));
														}
														sb_tFileOutputDelimited_4
																.append(OUT_DELIM_tFileOutputDelimited_4);
														if (SAIDA_VENDEDOR_MENSAL.UnitPrice != null) {
															sb_tFileOutputDelimited_4
																	.append(SAIDA_VENDEDOR_MENSAL.UnitPrice);
														}
														sb_tFileOutputDelimited_4
																.append(OUT_DELIM_tFileOutputDelimited_4);
														if (SAIDA_VENDEDOR_MENSAL.OrderQty != null) {
															sb_tFileOutputDelimited_4
																	.append(SAIDA_VENDEDOR_MENSAL.OrderQty);
														}
														sb_tFileOutputDelimited_4
																.append(OUT_DELIM_tFileOutputDelimited_4);
														if (SAIDA_VENDEDOR_MENSAL.Name != null) {
															sb_tFileOutputDelimited_4
																	.append(SAIDA_VENDEDOR_MENSAL.Name);
														}
														sb_tFileOutputDelimited_4
																.append(OUT_DELIM_tFileOutputDelimited_4);
														if (SAIDA_VENDEDOR_MENSAL.CountryRegion != null) {
															sb_tFileOutputDelimited_4
																	.append(SAIDA_VENDEDOR_MENSAL.CountryRegion);
														}
														sb_tFileOutputDelimited_4
																.append(OUT_DELIM_tFileOutputDelimited_4);
														if (SAIDA_VENDEDOR_MENSAL.SalesPerson != null) {
															sb_tFileOutputDelimited_4
																	.append(SAIDA_VENDEDOR_MENSAL.SalesPerson);
														}
														sb_tFileOutputDelimited_4
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderID", "row13", temp, ex_tFileInputDelimited_9),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderDetailID", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"OrderQty", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductID", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"UnitPrice", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"UnitPriceDiscount", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"LineTotal", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ModifiedDate", "row13", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
	...
	public void tFileInputDelimited_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_7 - inputs:(copyOfVENDAS,row14)
				// outputs:(copyOfSAIDA_VENDAS_PRODUTOS)
	...
	public void tFileInputDelimited_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_8 - inputs:(copyOfSAIDA_VENDAS_PRODUTOS,row15)
				// outputs:(copyOfSAIDA_VENDAS_REGIAO)
				...
				Object filename_tFileInputDelimited_11 = /** Start field tFileInputDelimited_11:FILENAME */
						"D:/DATA_OPS_PROJETO/RAW/FF_ADDRESS.CSV"/** End field tFileInputDelimited_11:FILENAME */
				;
					...
					try {// TD110 begin
						if (filename_tFileInputDelimited_11 instanceof java.io.InputStream) {
							...
							csvReadertFileInputDelimited_11 = new com.talend.csv.CSVReader(
									...
									fieldSeparator_tFileInputDelimited_11[0], "US-ASCII");
						} else {
							csvReadertFileInputDelimited_11 = new com.talend.csv.CSVReader(
									new java.io.BufferedReader(
											new java.io.InputStreamReader(
	...
	public void tFileInputDelimited_12Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_9 - inputs:(copyOfSAIDA_VENDAS_REGIAO,row16)
				// outputs:(SAIDA_VENDEDOR_MENSAL)
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CustomerID", "row16", temp, ex_tFileInputDelimited_12),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ModifiedDate", "row16", temp, ex_tFileInputDelimited_12),
											ex_tFileInputDelimited_12));
								}
...
// Start of branch "row16"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CURATED.class.getClassLoader()
					.getResourceAsStream("data_ops/curated_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CURATED.class.getClassLoader()
...
/************************************************************************************************
 * 622966 characters generated by Talend Open Studio for Big Data on the 2 de
 * Maio de 2021 15h56min17s BRT
 ************************************************************************************************/